...
import { AddBrandForm } from "@/components/form/add-brand-form";
import { DeleteMultiBrandsForm } from "@/components/form/delete-multi-brands-form"; // Use the multi-delete form
    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        ...
        <Dialog open={isDialogOpenAdd} onOpenChange={setIsDialogOpenAdd}>
          <AddBrandForm onClose={handleCloseDialogAdd} />
        </Dialog>
