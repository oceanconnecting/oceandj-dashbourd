...
// import { DataTablePagination } from "./data-table-pagination"; // Uncomment if pagination is needed
...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="space-y-4 pt-6">
      ...
      {/* <DataTablePagination table={table} /> */} {/* Uncomment if pagination is needed */}
    </div>
  );
}
