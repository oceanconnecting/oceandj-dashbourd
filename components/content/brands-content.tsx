...
import { fetchBrands } from "@/app/redux/features/brands/brandsSlice";
...
export function BrandsContent() {
  ...
  const { brands, loading, error, total, totalPages } = useAppSelector((state: RootState) => state.brands);
  ...
  useEffect(() => {
    ...
    dispatch(fetchBrands({ searchTerm, page, limit }));
