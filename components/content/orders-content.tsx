...
import { fetchOrders } from "@/app/redux/features/orders/ordersSlice";
...
export const OrdersContent = () => {
  ...
  const { orders, loading, error, total, totalPages } = useAppSelector((state: RootState) => state.orders);
  ...
  useEffect(() => {
    ...
    dispatch(fetchOrders({ searchTerm, page, limit }));
